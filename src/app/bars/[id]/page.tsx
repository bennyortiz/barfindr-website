...
export default function BarDetailPage() {
  ...
  return (
    <PageLayout fullWidth={false} noPadding={true}>
      {/* Hero section with image - this needs to be full width */}
      <div className="relative h-[40vh] sm:h-[45vh] md:h-[50vh] w-full -mx-4 sm:-mx-6 md:-mx-8 lg:-mx-10">
        ...
        />
        <div className="absolute bottom-0 z-20 pb-8 md:pb-12 w-full px-4 sm:px-6 md:px-8 lg:px-10 max-w-[1536px] mx-auto">
