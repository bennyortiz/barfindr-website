 ...
 */
export function generateCategoryMetadata(attribute: string, value: string, title: string, description: string): Metadata {
  // Format the attribute and value for keywords
